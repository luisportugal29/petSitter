...
export class InitialSchema1692773115128 implements MigrationInterface {
    name = 'InitialSchema1692773115128'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sitter" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "lastName" varchar NOT NULL, "email" varchar NOT NULL, "phoneNumber" varchar NOT NULL, "birthDate" date NOT NULL, "cityId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_sitter" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "lastName" varchar NOT NULL, "email" varchar NOT NULL, "phoneNumber" varchar NOT NULL, "birthDate" date NOT NULL, "cityId" integer, CONSTRAINT "FK_d49c1eafbca7a5401a66ae2f070" FOREIGN KEY ("cityId") REFERENCES "city" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_sitter"("id", "name", "lastName", "email", "phoneNumber", "birthDate", "cityId") SELECT "id", "name", "lastName", "email", "phoneNumber", "birthDate", "cityId" FROM "sitter"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sitter" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "lastName" varchar NOT NULL, "email" varchar NOT NULL, "phoneNumber" varchar NOT NULL, "birthDate" date NOT NULL, "cityId" integer)`);
        await queryRunner.query(`INSERT INTO "sitter"("id", "name", "lastName", "email", "phoneNumber", "birthDate", "cityId") SELECT "id", "name", "lastName", "email", "phoneNumber", "birthDate", "cityId" FROM "temporary_sitter"`);
